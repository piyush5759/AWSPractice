...
public class AmazonDynamoDBSample {
     ...
     *      (/Users/piyukuma/.aws/credentials) where the sample code will load the
     *      credentials from.
    ...
    private static void init() throws Exception {
         ...
         * (/Users/piyukuma/.aws/credentials).
         */
        AWSCredentials credentials = null;
        try {
            credentials = new ProfileCredentialsProvider("My Personal").getCredentials();
        } catch (Exception e) {
            throw new AmazonClientException(
                    "Cannot load the credentials from the credential profiles file. " +
                    "Please make sure that your credentials file is at the correct " +
                    "location (/Users/piyukuma/.aws/credentials), and is in valid format.",
                    e);
        }
    ...
    public static void main(String[] args) throws Exception {
        init();
        AmazonDynamoDBSample.createTable();
        //list table available
        AmazonDynamoDBSample.DisplayTable();
    }
